...
describe('Auth expired cleanup', () => {
  ...
  it('expired unauthorized durumda storage temizlenir ve retry icin recoverable session korunur', async () => {
    ...
    expect(screen.getByTestId('error-code')).toHaveTextContent('AUTH_UNAUTHORIZED')
    expect(screen.getByTestId('retry-flag')).toHaveTextContent('yes')
