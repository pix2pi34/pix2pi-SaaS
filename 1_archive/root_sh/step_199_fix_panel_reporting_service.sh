...
echo
echo "2) Panel dosyasi kontrol ediliyor..."
...
echo "OK ✅ yedek alindi: $yedek_dizin/panel_index.html.$zaman.bak"

echo
echo "4) Panel dosyasi reporting_service destekleyecek sekilde yeniden yaziliyor..."
...
echo
echo "7) Hizli kontrol..."
grep -n "reporting_service" "$panel_dosya"
echo "OK ✅ reporting_service panel dosyasinda var"

echo
echo "8) Bitti"
echo "Paneli tamamen kapat-ac yap"
echo "Gerekirse gizli sekme ile ac"
