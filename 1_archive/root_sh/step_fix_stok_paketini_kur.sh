...
mkdir -p internal/erp/core/stok/domain
mkdir -p internal/erp/core/stok/service

cat <<'GOEOF' > internal/erp/core/stok/domain/erp_urun_kart.go
package domain
...
cat <<'GOEOF' > internal/erp/core/stok/domain/erp_stok_hareket.go
package domain
...
cat <<'GOEOF' > internal/erp/core/stok/service/erp_stok_service.go
package service
...
echo "OK ✅ stok paketi kalici olarak kuruldu"
