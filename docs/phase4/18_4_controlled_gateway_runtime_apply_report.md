...
Generated at: 2026-04-27 20:17:53 

## Summary
ROOT_DIR=/root/pix2pi/pix2pi-SaaS
APPLY_REPORTING_RUNTIME=1
APPLY_EXECUTED=YES
DB_MUTATION=NO
...
PREVIOUS_18_3_SELECTED_ENTRY_TARGET=cmd/api-gateway/api_gateway_main.go
PREVIOUS_18_3_SELECTED_ENTRY_TARGET_KIND=API_GATEWAY
PREVIOUS_18_3_REPORTING_GO_TEST_SUITE=PASS
PREVIOUS_18_3_API_GATEWAY_GO_TEST_STATUS=PASS
PREVIOUS_18_3_APPLY_EXECUTED=NO
PREVIOUS_18_3_REPORTING_RUNTIME_STARTED=NO
PREVIOUS_18_3_GATEWAY_CONFIG_CHANGED=NO
PREVIOUS_18_3_DB_MUTATION=NO
...
TARGET_FILE_STATUS=FOUND
RUNTIME_REGISTRATION_FILE_STATUS=FOUND
TARGET_SHA256_BEFORE=8aa1f982c1f2a62a023dca0c1dc25e2d1295115ae05cac12b902c558c93b3484
MODULE_PATH=github.com/divrigili/pix2pi-SaaS
REPORTING_RUNTIME_IMPORT_PATH=github.com/divrigili/pix2pi-SaaS/internal/platform/reporting/runtime
BACKUP_FILE=backups/faz4_18_4_runtime_apply_file_backup_20260427_201753/cmd/api-gateway/api_gateway_main.go
BACKUP_CREATED=YES
TARGET_SHA256_AFTER=8aa1f982c1f2a62a023dca0c1dc25e2d1295115ae05cac12b902c558c93b3484
...
CONTROLLED_APPLY_INVENTORY_LINE_COUNT=14
CONTROLLED_APPLY_MATRIX_LINE_COUNT=15
...
item	status	note
target_file	FOUND	cmd/api-gateway/api_gateway_main.go
runtime_registration	FOUND	internal/platform/reporting/runtime/registration.go
backup_file	CREATED	backups/faz4_18_4_runtime_apply_file_backup_20260427_201753/cmd/api-gateway/api_gateway_main.go
module_path	FOUND	github.com/divrigili/pix2pi-SaaS
import_path	SET	github.com/divrigili/pix2pi-SaaS/internal/platform/reporting/runtime
patch_mode	NOOP_ALREADY_APPLIED	insert_strategy=ALREADY_APPLIED
gateway_code_changed	NO	before=8aa1f982c1f2a62a023dca0c1dc25e2d1295115ae05cac12b902c558c93b3484 after=8aa1f982c1f2a62a023dca0c1dc25e2d1295115ae05cac12b902c558c93b3484
reporting_import_count_after	1	expected=1
reporting_register_call_count_after	1	expected=1
gofmt_status	PASS	target=cmd/api-gateway/api_gateway_main.go
reporting_go_test_suite	PASS	internal/platform/reporting
api_gateway_go_test_status	PASS	cmd/api-gateway
rollback_ready	YES	restore backup target file

## Controlled Apply Matrix
MATRIX_FILE=docs/phase4/18_4_controlled_gateway_runtime_apply_matrix.tsv
gate	status	note
previous_18_3_gate	PASS	apply_gate_ready=YES
previous_17_final	PASS	reporting api closure
target_file	FOUND	cmd/api-gateway/api_gateway_main.go
backup_created	YES	backups/faz4_18_4_runtime_apply_file_backup_20260427_201753/cmd/api-gateway/api_gateway_main.go
patch_applied	NOOP_ALREADY_APPLIED	mode=NOOP_ALREADY_APPLIED
reporting_import_after	1	expected=1
reporting_register_call_after	1	expected=1
gofmt	PASS	go format target
reporting_go_test_suite	PASS	internal reporting tests
api_gateway_go_test	PASS	api gateway tests
...
controlled_apply	PASS	failures=0 warnings=0
...
## Rollback Plan
ROLLBACK_SOURCE=backups/faz4_18_4_runtime_apply_file_backup_20260427_201753/cmd/api-gateway/api_gateway_main.go
ROLLBACK_TARGET=cmd/api-gateway/api_gateway_main.go
...
ROUTE_REGISTRATION_CREATED=NOOP_ALREADY_APPLIED
REPORTING_RUNTIME_STARTED=NO
SERVICE_RUNTIME_STARTED=NO
PORT_OPENED=NO
