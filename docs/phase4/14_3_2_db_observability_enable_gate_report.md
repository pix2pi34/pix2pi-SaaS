# FAZ 4 / 14.3.2 - DB Observability Enable Gate Report
...
VACUUM_EXECUTED=NO
CANDIDATE_PLAN_FILE=docs/phase4/14_3_2_db_observability_candidate_plan.sh
DB_OBSERVABILITY_PERFORMANCE_DISCOVERY=PASS
PREVIOUS_DB_PERF_RISK_LEVEL=MEDIUM
...
DB_OBSERVABILITY_ENABLE_DECISION=PLAN_READY_APPLY_NOT_EXECUTED
DB_OBSERVABILITY_CANDIDATE_PLAN_CREATED=YES
DB_OBSERVABILITY_CANDIDATE_PLAN_BLOCKED_BY_DEFAULT=YES
FAIL_COUNT=0
WARN_COUNT=0
...
## Risks
RISK_RESTART_REQUIRED=pg_stat_statements preload icin PostgreSQL restart gerekir
RISK_EXTENSION_MISSING=pg_stat_statements extension DB icinde kurulu degil
RISK_TRACK_IO_TIMING_OFF=track_io_timing off
RISK_SLOW_QUERY_LOG_DISABLED=log_min_duration_statement disabled
