# 112 — FAZ 3-10.3.3 — e-Adisyon provider entegrasyonu

## Amaç

Bu adım, e-Adisyon provider entegrasyonu için provider bağımsız runtime adapter temelini oluşturur.
...
- Venue / table / adisyon no guard
- opened_at / closed_at guard
