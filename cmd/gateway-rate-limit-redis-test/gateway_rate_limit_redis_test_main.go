...
func main() {
	fmt.Println("STEP redis gateway rate limit testi basliyor")
	fmt.Println("-------------------------------------------")
	...
	svc := gatewayservice.NewRateLimitServiceWithRedis(redisSvc)
	...
	fmt.Println("OK ✅ test oncesi sayaç sifirlandi")
	...
	fmt.Println("OK ✅ STEP redis gateway rate limit testi bitti")
}
