...
for rec in plan.get("recommendations", []):
    recommendations.append({
        ...
        "storage_surface": rec.get("storage_surface"),
        "storage_class": rec.get("storage_class"),
        "current_cost_driver": rec.get("current_cost_driver"),
        "recommended_action": rec.get("recommended_action"),
        "estimated_savings_level": rec.get("estimated_savings_level"),
        "risk_level": rec.get("risk_level"),
        "retention_guard_status": rec.get("retention_guard_status"),
        ...
        "status": "DRY_RUN_STORAGE_LOG_COST_RECOMMENDATION_ONLY"
    })

print(json.dumps({
    "runtime_status": "PASS",
    "mode": "storage_log_cost_optimization_dry_run",
    "provider_mutation_allowed": config.get("provider_mutation_allowed"),
    "storage_delete_allowed": config.get("storage_delete_allowed"),
    "log_delete_allowed": config.get("log_delete_allowed"),
    "backup_delete_allowed": config.get("backup_delete_allowed"),
    "audit_delete_allowed": config.get("audit_delete_allowed"),
    "evidence_delete_allowed": config.get("evidence_delete_allowed"),
