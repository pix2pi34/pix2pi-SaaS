...
PHASE="FAZ_1_1_6_NAMING_INDEX_CONVENTION_STANDARD"

BACKUP_DIR="$REPO/backups/faz1/faz_1_1_6_naming_index_convention_standard_$TS"
...
APPLY_SCRIPT_FILE="$SCRIPT_DIR/faz_1_1_6_naming_index_convention_standard_apply.sh"
...
MIGRATION_FILE="$MIGRATION_DIR/${TS}_faz_1_1_6_naming_index_convention_standard.sql"
EVIDENCE_FILE="$EVIDENCE_DIR/${PHASE}_REAL_IMPLEMENTATION_AUDIT.md"
FINAL_SEAL_FILE="$EVIDENCE_DIR/FAZ_1_1_6_NAMING_INDEX_CONVENTION_STANDARD_FINAL_SEAL_$TS.md"
STRICT_SUITE_OUT="$SUITE_RUNTIME_DIR/faz_1_1_6_strict_suite_run.out"

TABLE_NAMING_VIOLATIONS_CSV="$BACKUP_DIR/table_naming_violations.csv"
COLUMN_NAMING_VIOLATIONS_CSV="$BACKUP_DIR/column_naming_violations.csv"
INDEX_NAMING_VIOLATIONS_CSV="$BACKUP_DIR/index_naming_violations.csv"
FK_NAMING_VIOLATIONS_CSV="$BACKUP_DIR/fk_naming_violations.csv"
UNIQUE_NAMING_VIOLATIONS_CSV="$BACKUP_DIR/unique_naming_violations.csv"
NAMING_SNAPSHOT_CSV="$BACKUP_DIR/naming_convention_snapshot.csv"
...
echo "===== FAZ 1-1.6 NAMING / INDEX CONVENTION STANDARD APPLY START ====="
...
echo "7. naming standard helper migration hazırlanıyor..."
...
echo "8. naming standard helper migration uygulanıyor..."
...
echo "9. naming convention snapshot ve violation dosyaları üretiliyor..."
...
BACKUP_DIR="${BACKUP_DIR:-$REPO/backups/faz1/faz_1_1_6_naming_index_convention_standard_strict_suite_$TS}"
EVIDENCE_DIR="$REPO/docs/faz1/evidence"
EVIDENCE_FILE="$EVIDENCE_DIR/FAZ_1_1_6_NAMING_INDEX_CONVENTION_STANDARD_STRICT_SUITE_RESULT_$TS.md"
...
echo "===== FAZ 1-1.6 NAMING / INDEX CONVENTION STANDARD STRICT SUITE START ====="
...
SQL_SUITE_FILE="$BACKUP_DIR/naming_index_convention_standard_strict_assertion.sql"
SQL_SUITE_OUT="$BACKUP_DIR/naming_index_convention_standard_strict_assertion.out"
...
{
  echo "# FAZ 1-1.6 Naming / Index Convention Standard Strict Suite Result"
  echo
  echo "- Tarih: $(date -Is)"
  echo "- Repo: $REPO"
...
echo "===== FAZ 1-1.6 NAMING / INDEX CONVENTION STANDARD STRICT SUITE END ====="
SUITE
...
- Tablo ve kolon adları snake_case olmalıdır.
- Index adları idx_, ux_, pk_, fk_, uq_, gin_, gist_, brin_ prefix standardını veya PostgreSQL legacy _pkey/_key/_idx/_fkey uyumluluğunu karşılamalıdır.
- FK constraint adları fk_ prefix standardını veya PostgreSQL legacy _fkey uyumluluğunu karşılamalıdır.
- Unique constraint adları ux_/uq_ prefix standardını veya PostgreSQL legacy _key uyumluluğunu karşılamalıdır.

## Güvenli Uygulama Notu

Bu adım tablo/kolon rename yapmaz. Rename işlemi canlı servisleri kırabileceği için standard helper ve strict audit yaklaşımı kullanıldı.
...
{
  echo "# FAZ 1-1.6 Naming / Index Convention Standard Real Implementation Audit"
  echo
  echo "- Tarih: $(date -Is)"
  echo "- Repo: $REPO"
...
{
  echo "# FAZ 1-1.6 Naming / Index Convention Standard Final Seal"
  echo
  echo "- Tarih: $(date -Is)"
...
echo "===== FAZ 1-1.6 NAMING / INDEX CONVENTION STANDARD APPLY RESULT ====="
echo "PASS_COUNT=$PASS_COUNT"
echo "FAIL_COUNT=$FAIL_COUNT"
echo "WARN_COUNT=$WARN_COUNT"
echo "TABLE_TOTAL_COUNT=$TABLE_TOTAL_COUNT"
...
echo "===== FAZ 1-1.6 NAMING / INDEX CONVENTION STANDARD APPLY END ====="
