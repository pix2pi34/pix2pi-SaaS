...
ALTER TABLE org.branches DROP CONSTRAINT IF EXISTS ck_org_branches_required_fields;
ALTER TABLE org.branches
...
ALTER TABLE org.branches DROP CONSTRAINT IF EXISTS ck_org_branches_branch_type;
ALTER TABLE org.branches
  ADD CONSTRAINT ck_org_branches_branch_type
  CHECK (branch_type IS NOT NULL AND btrim(branch_type::text) <> '') NOT VALID;

ALTER TABLE org.branches DROP CONSTRAINT IF EXISTS ck_org_branches_status;
ALTER TABLE org.branches
...
ALTER TABLE org.branch_addresses DROP CONSTRAINT IF EXISTS ck_org_branch_addresses_required_fields;
ALTER TABLE org.branch_addresses
...
ALTER TABLE org.branch_addresses DROP CONSTRAINT IF EXISTS ck_org_branch_addresses_address_type;
ALTER TABLE org.branch_addresses
  ADD CONSTRAINT ck_org_branch_addresses_address_type
  CHECK (address_type IS NOT NULL AND btrim(address_type::text) <> '') NOT VALID;

ALTER TABLE org.branch_addresses DROP CONSTRAINT IF EXISTS ck_org_branch_addresses_status;
ALTER TABLE org.branch_addresses
...
BEGIN
  IF EXISTS (
    ...
    SELECT
      ...
      jsonb_build_object('phase','FAZ_1_1_3_FIX_V3','source','branch_model'),
      now()
